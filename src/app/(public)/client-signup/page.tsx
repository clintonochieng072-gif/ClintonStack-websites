...
function ClientSignupForm() {
  ...
  useEffect(() => {
    ...
    // Check for referral code and product in URL
    ...
    if (product) {
      ...
      // You could fetch product details here if needed
      setProductName(
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      const state = ref
        ? JSON.stringify({ role: "client", referralCode: ref })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      } else if (data.user.role === "client" && !data.user.onboarded) {
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Build and manage your professional website with ClintonStack
          </p>
          {referralCode && (
