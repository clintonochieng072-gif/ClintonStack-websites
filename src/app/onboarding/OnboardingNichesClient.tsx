...
export default function OnboardingNichesClient() {
  ...
  useEffect(() => {
    if (sitesData) {
      ...
      // For onboarding, always stay on page to select
      setLoading(false);
    } else if (error) {
      setLoading(false);
    }
  ...
  const handleNicheSelect = async (nicheId: string) => {
    ...
    if (existingSite) {
      // Site exists, complete onboarding and redirect
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Choose your business niche to create your first professional
            website.
          </p>
        </motion.div>
          ...
          >
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">
                Welcome to ClintonStack! 🎉
              </h3>
              <p className="text-gray-600 mb-4">
                Your {niches.find((n) => n.id === selectedNiche)?.name} website
                has been created and you're all set up.
              </p>
