        ...
        <CardContent className="space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
            <p className="text-sm text-blue-800">
              ...
              <br />
              Add your phone number or WhatsApp number to show floating contact
              buttons on your site. Visitors will be able to call or message you
              directly.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input
                ...
                onChange={(e) => updateIntegration("tawkToId", e.target.value)}
